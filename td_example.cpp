...
const int myApiId = 94575;

class TdExample {
 public:
    TdExample() : client_id_(client_manager_->create_client_id()) {
    ...
    void loop() {
        while (true) {
            if (need_restart_) {
                ...
                if (action == "show chats") {
                    std::cout << "still in dev\n";
                }
                if (action == "u") {
                    ...
                    send_query(td_api::make_object<td_api::getMe>(), [this](Object object) { std::cout << to_string(object) << std::endl; });
                } else if (action == "l") {
                    ...
                    send_query(td_api::make_object<td_api::getChats>(nullptr, 20), [this](Object object) {
                        ...
                        std::cout << "Finished searching for chats!\n";
    ...
    void process_update(td_api::object_ptr<td_api::Object> update) {
        td_api::downcast_call(
            *update, overloaded(
                         ...
                         [this](td_api::updateNewChat& update_new_chat) { chat_title_[update_new_chat.chat_->id_] = update_new_chat.chat_->title_; },
                         [this](td_api::updateChatTitle& update_chat_title) { chat_title_[update_chat_title.chat_id_] = update_chat_title.title_; },
                         ...
                         [this](td_api::updateNewMessage& update_new_message) {
                             ...
                             if (update_new_message.message_->content_->get_id() == td_api::messageText::ID) {
                                 text = dynamic_cast<td_api::messageText&>(*update_new_message.message_->content_).text_->text_;
                             }
        ...
        td_api::downcast_call(
            *authorization_state_,
            overloaded(
                ...
                [this](td_api::authorizationStateWaitPremiumPurchase&) { std::cout << "Telegram Premium subscription is required" << std::endl; },
                ...
                [this](td_api::authorizationStateWaitEmailCode&) {
                    ...
                    std::cin >> code;
                    send_query(
                        td_api::make_object<td_api::checkAuthenticationEmailCode>(td_api::make_object<td_api::emailAddressAuthenticationCode>(code)),
                        create_authentication_query_handler());
                },
